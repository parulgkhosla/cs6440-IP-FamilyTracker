              ...
              <div className="flex" style={{flex: 1, flexWrap: "wrap"}}>
                <div className="flex flex-col" style={{flex: 1}}>
                  ...
                  <div className="flex flex-col" style={{marginTop: "1em"}}>
                    <div className="flex flex-col"
                         style={{display: patientData.firstName !== undefined ? 'block' : 'none'}}>
                      <table>
                        <tbody>
                        <div className="flex">
                          <tr style={{width: "20em", flex: 1}}>
                            ...
                            {patientData.firstName !== undefined ?
                                <TableRow title={patientData.firstName + " " + patientData.lastName}/> :
                                <TableRow title="N/A"/>}
                          </tr>
                        </div>
                        </tbody>
                    ...
                    <div className="flex flex-col"
                         style={{display: patientData.address !== undefined ? 'block' : 'none'}}>
                      <table>
                        <tbody>
                        <div className="flex">
                          <tr style={{width: "20em", flex: 1}}>
                  ...
                  <div className="flex flex-col"
                       style={{display: patientData.dateOfBirth !== undefined ? 'block' : 'none'}}>
                    <table>
                      <tbody>
                      <div className="flex">
                        <tr style={{width: "20em", flex: 1}}>
                        ...
                        <tr style={{width: "20em", flex: 1}}>
                          ...
                          {patientData.bmi !== undefined ?
                              <td className={classNames("table-label")} style={{
                                ...
                                visibility: patientData.bmi !== undefined ? 'visible' : 'hidden'
                              }}>{patientData.bmi}</td> : <TableRow title="N/A"/>}
                        </tr>
                      </div>
                      </tbody>
                    </table>
                ...
                <div className="flex flex-col" style={{flex: 1, flexWrap: "wrap"}}>
                  <div className="flex" style={{flexWrap: "wrap"}}>
                    ...
                    <div className="flex flex-col" style={{marginTop: "1em"}}>
                      <div className="flex flex-col"
                           style={{display: patientData.medications !== undefined ? 'block' : 'none'}}>
                        <table>
                          <tbody>
                          <div className="flex">
                  ...
                  <div className="flex" style={{flexWrap: "wrap"}}>
                    ...
                    <div className="flex flex-col" style={{marginTop: "1em"}}>
                      <div className="flex flex-col"
                           style={{display: patientData.allergies !== undefined ? 'block' : 'none'}}>
                        <table>
                          <tbody>
                          <div className="flex">
                            <tr style={{width: "20em", flex: 1, fontWeight: 'bold'}}>
                  ...
                  <div className="flex" style={{flexWrap: "wrap"}}>
                    ...
                    <div className="flex flex-col" style={{marginTop: "1em"}}>
                      <div className="flex flex-col"
                           style={{display: patientData.conditions !== undefined ? 'block' : 'none'}}>
                        <table>
                          <tbody>
                  ...
                  <div className="flex" style={{flexWrap: "wrap"}}>
                    ...
                    <div className="flex flex-col" style={{marginTop: "1em"}}>
                      <div className="flex flex-col"
                           style={{display: patientData.encounters !== undefined ? 'block' : 'none'}}>
                        <table>
                          <tbody>
                          <div className="flex">
                            <tr style={{width: "20em", flex: 1, fontWeight: 'bold'}}>
                        ...
                        return member && (
                            <div className="flex flex-col" style={{flex: 1}}>
                              ...
                              <div className="flex flex-col" style={{flex: 1}}>
                                ...
                                <div className="flex flex-col" style={{marginTop: "1em"}}>
                                  <div className="flex flex-col"
                                       style={{display: member.firstName !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1}}>
                                          ...
                                          {member.firstName !== undefined ?
                                              <TableRow title={member.firstName + " " + member.familyName}/> :
                                              <TableRow title="N/A"/>}
                                        </tr>
                                      </div>
                                      </tbody>
                                  ...
                                  <div className="flex flex-col"
                                       style={{display: member.relationship !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1}}>
                                  ...
                                  <div className="flex flex-col"
                                       style={{display: member.address !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1}}>
                                ...
                                <div className="flex flex-col"
                                     style={{display: member.birthDate !== undefined ? 'block' : 'none'}}>
                                  <table>
                                    <tbody>
                                    <div className="flex">
                                      <tr style={{width: "20em", flex: 1}}>
                                ...
                                <div className="flex flex-col"
                                     style={{display: member.age !== undefined ? 'block' : 'none'}}>
                                  <table>
                                    <tbody>
                                    <div className="flex">
                                      <tr style={{width: "20em", flex: 1}}>
                                ...
                                <div className="flex flex-col"
                                     style={{display: member.bmi !== undefined ? 'block' : 'none'}}>
                                  <table>
                                    <tbody>
                                    <div className="flex">
                                      <tr style={{width: "20em", flex: 1}}>
                                        ...
                                        {member.bmi !== undefined ?
                                            <td className={classNames("table-label")} style={{
                                              ...
                                              visibility: member.bmi !== undefined ? 'visible' : 'hidden'
                                            }}>{member.bmi}</td> : <TableRow title="N/A"/>}
                                      </tr>
                                    </div>
                                    </tbody>
                                  </table>
                              ...
                              <div className="flex" style={{flexWrap: "wrap"}}>
                                ...
                                <div className="flex flex-col" style={{marginTop: "1em"}}>
                                  {member.medications}
                                  <div className="flex flex-col"
                                       style={{display: member.medications !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1, fontWeight: 'bold'}}>
                              ...
                              <div className="flex" style={{flexWrap: "wrap"}}>
                                ...
                                <div className="flex flex-col" style={{marginTop: "1em"}}>
                                  <div className="flex flex-col"
                                       style={{display: member.allergies !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1, fontWeight: 'bold'}}>
                              ...
                              <div className="flex" style={{flexWrap: "wrap"}}>
                                ...
                                <div className="flex flex-col" style={{marginTop: "1em"}}>
                                  <div className="flex flex-col"
                                       style={{display: member.conditions !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                              ...
                              <div className="flex" style={{flexWrap: "wrap"}}>
                                ...
                                <div className="flex flex-col" style={{marginTop: "1em"}}>
                                  <div className="flex flex-col"
                                       style={{display: member.encounters !== undefined ? 'block' : 'none'}}>
                                    <table>
                                      <tbody>
                                      <div className="flex">
                                        <tr style={{width: "20em", flex: 1, fontWeight: 'bold'}}>
